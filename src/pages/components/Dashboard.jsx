            ...
            <div class="flex flex-wrap gap-4 px-4 py-6">
              ...
              <div class="flex min-w-72 flex-1 flex-col gap-2 rounded-xl border border-gray-800 p-6">
               ...
               <div class="p-4 @container">
                 <div class="flex flex-1 items-start justify-between gap-4 rounded-xl border border-[#3b4954] bg-black p-5 @[480px]:flex-row @[480px]:items-center">
                   <p class="text-white text-base font-bold leading-tight">Add your first product</p>
                   <button
